...
async function getUserProfile(username) {
  ...
  async function getURL() {
    ...
    const socialWapper = document.getElementsByClassName("social--wrapper")
    console.log(socialWapper)
    ...
    githubCard.innerHTML = `
      ...
      <div class="github__card--stats">
        <div class="stats--wrapper stats-repos--wrapper">
          <h3 class="fs-stats-text stats-repos">Repos</h3>
          <h2 class="fs-heading fs-stats-totals stats-repos--total">${
            data.public_repos
          }</h2>
        </div>
        <div class="stats--wrapper stats-followers--wrapper">
          <h3 class="fs-stats-text stats-followers">Followers</h3>
          <h2 class="fs-heading fs-stats-totals stats-followers--total">
            ${data.followers}
          </h2>
        </div>
        <div class="stats--wrapper stats-following--wrapper">
          <h3 class="fs-stats-text stats-following">Following</h3>
          <h2 class="fs-heading fs-stats-totals stats-following--total">${
            data.following
          }</h2>
        </div>
      </div>

      <div class="github__card--social flow">
        <div class="social--wrapper location">
        ...
        <div class="social--wrapper company">
