  ...
  async function getURL() {
    ...
    githubCard.innerHTML = `
      ...
      <ul class="github__card--social flow">
        <li class="social--wrapper location  ${(data.location  === '' || data.location === null)  ? "not-available"  : ''}">
        ...
        <li class="social--wrapper twitter  ${(data.twitter_username  === '' || data.twitter_username === null)  ? "not-available"  : ''}">
        ...
        <li class="social--wrapper website ${(data.blog  === '' || data.blog === null)  ? "not-available"  : ''}">
        ...
        <li class="social--wrapper company ${(data.company  === '' || data.company === null)  ? "not-available"  : ''}">
